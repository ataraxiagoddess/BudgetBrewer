...
object ValidationUtils {
    ...
    fun isValidPin(pin: String): Boolean = pin.length == MAX_LENGTH_PIN && pin.all { it.isDigit() }
    ...
    fun isValidRecurrenceDays(days: Int): Boolean = days in 5..MAX_RECURRENCE_DAYS
     ...
     */
    fun getLengthFilter(maxLength: Int): InputFilter = InputFilter.LengthFilter(maxLength)
