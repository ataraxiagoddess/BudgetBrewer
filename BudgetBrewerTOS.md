...
These terms and conditions apply to the Budget Brewer app for mobile devices, together with any related services operated by Chastity DeLoof (collectively, the "Application"). Chastity DeLoof is hereby referred to as the "Service Provider".
...
The Application is a budgeting and financial tracking tool provided for informational and organizational purposes only. The Service Provider is not a financial advisor, accountant, or investment professional. Nothing in this Application constitutes financial advice, investment advice, or accounting advice.

You should consult with qualified financial professionals before making any financial decisions. The Service Provider makes no representations or warranties about the accuracy, completeness, or suitability of the information contained in the Application for any particular purpose. Your use of the Application and reliance on any information provided is solely at your own risk.

## Data Accuracy and User Responsibility

You are solely responsible for the accuracy and completeness of the financial data you enter into the Application. The Service Provider does not verify, validate, or guarantee the accuracy of any user-entered data, calculations, or projections generated by the Application.

While the Application includes features to help you track and manage your finances, you should independently verify all financial information and calculations before making any financial decisions.

## Cloud Synchronization and Data Backup

If you choose to create an account and use cloud synchronization features, your data will be stored on third-party servers (Supabase). While the Service Provider implements reasonable security measures, you acknowledge that:

*   Internet transmission and storage of data is never completely secure
*   You are responsible for maintaining backups of important financial data
*   The Service Provider is not liable for data loss, corruption, or unauthorized access despite security measures
*   You can export your data at any time using the Application's export features
...
If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at budgetbrewersupport@gmail.com. The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.
...
The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at budgetbrewersupport@gmail.com to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
...
**Point of Contact:** The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at budgetbrewersupport@gmail.com. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
...
Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at budgetbrewersupport@gmail.com.

These terms and conditions are effective as of 2026-06-07

**Contact Us**

If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at budgetbrewersupport@gmail.com.
